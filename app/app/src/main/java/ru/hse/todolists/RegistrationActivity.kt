...
import ru.hse.todolists.databinding.ActivityRegistrationBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        registrationViewModel.registrationFormState.observe(this@RegistrationActivity, Observer {
            ...
            if (register.isEnabled) {
                register.setBackgroundColor(resources.getColor(R.color.black))
            } else {
                register.setBackgroundColor(resources.getColor(R.color.white))
            }
        })
